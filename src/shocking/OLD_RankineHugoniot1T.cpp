...
void RankineHugoniot1T::applyShockRelations(const Data& l_data_before, Data& l_data_after){
    ...
    // THIS NEEDS TO BE FIXED: make sub-iterations to set the translational and 
    // internal tempertaures equal!
//    std::cerr << "NO, I CAN NOT LET YOU RUN THIS! THIS NEEDS TO BE FIXED OR YOU'LL "
//              << "GET WRONG RESULTS!!! In RankineHugoniot1T.cpp" << std::endl;
//    exit(1);
    std::cerr << "YOU SHOULDN'T RUN THIS! In RankineHugoniot1T.cpp" << std::endl;
