%
% This script reads an "external flowfield file" computed by Shocking
...
% Load external shocking flowfield file
dd = load('output.dat');
...
legend('Shocking', 'LARSEN')
title('RED: Shocking, BLUE: LARSEN results', 'fontsize', 14)
