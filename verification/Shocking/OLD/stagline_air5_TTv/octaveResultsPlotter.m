...
% Rescale position
xx = xx(posStart)-xx - 0.002106;

% PLOT
figure
hold on
plot(xx, TT, 'ob', 'linewidth', 1)
plot(xx, Tv, '+r', 'linewidth', 1)

plot(xx_S, TT_S, 'b', 'linewidth', 2)
plot(xx_S, Tv_S, 'r', 'linewidth', 2)

title('SYMBOLS: stagline - SOLID: shocking')
ylabel('velocity')
xlabel('x [m]')
...
figure
hold on
plot(xx, uu, 'g', 'linewidth', 2)
plot(xx_S, uu_S, 'b', 'linewidth', 2)
legend('stagline', 'shocking')
ylabel('velocity')
xlabel('x [m]')
